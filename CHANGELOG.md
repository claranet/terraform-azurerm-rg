...
* **tflint:** 🐛 bump Azure rules version, fix signature bug ff25a9c

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 48d3287
* **deps:** update dependency opentofu to v1.12.2 5803f72
* **deps:** update dependency opentofu to v1.12.3 e655d04
* **deps:** update dependency opentofu to v1.12.4 c3a9aee
* **deps:** update dependency tflint to v0.63.1 45f7914
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 befc632
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 3f769c8

## 8.0.6 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ a3116ca

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu e686070
* **deps:** update dependency opentofu to v1.11.7 46ecc1b
* **deps:** update dependency opentofu to v1.12.0 ee545c7
* **deps:** update dependency terraform-docs to v0.23.0 90f786d
* **deps:** update dependency terraform-docs to v0.24.0 96aa17e
* **deps:** update dependency tflint to v0.62.1 9aade3a
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 8005617
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 8a56fa5
* **pre-commit:** 🔧 move to prek 5fea5ad
* **tfdocs:** bump tfdocs to v0.22 🔧 447e318
...
* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ 198ad33

### Code Refactoring

* **module:** ♻️ apply best-practices cleanup c04625e

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing acdd013
* **deps:** 🔗 bump tflint rules version ae23548
* **deps:** update dependency trivy to v0.69.2 9529045
* **deps:** update dependency trivy to v0.69.3 431f507
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 a1a9bfa

## 8.0.2 (2026-02-13)

### Code Refactoring

* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 278ed0b

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.10.7 75979a7
* **deps:** update dependency opentofu to v1.11.2 74ab7b7
* **deps:** update dependency opentofu to v1.11.3 dae4565
* **deps:** update dependency opentofu to v1.11.4 8ffe47b
* **deps:** update dependency opentofu to v1.11.5 d006226
* **deps:** update dependency pre-commit to v4.4.0 df73515
* **deps:** update dependency pre-commit to v4.5.0 24b89be
* **deps:** update dependency pre-commit to v4.5.1 dd0bfca
* **deps:** update dependency tflint to v0.60.0 3386713
* **deps:** update dependency tflint to v0.61.0 f64d2b4
* **deps:** update dependency trivy to v0.67.0 f4fd42b
* **deps:** update dependency trivy to v0.67.1 9e17be5
* **deps:** update dependency trivy to v0.67.2 73ba183
* **deps:** update dependency trivy to v0.68.1 9557481
* **deps:** update dependency trivy to v0.68.2 46db5ac
* **deps:** update dependency trivy to v0.69.0 08646b2
* **deps:** update dependency trivy to v0.69.1 fb88862
* **deps:** update pre-commit hook crate-ci/committed to v1.1.10 4a3e0e4
* **deps:** update pre-commit hook crate-ci/committed to v1.1.8 251324e
* **deps:** update pre-commit hook crate-ci/committed to v1.1.9 5310c34
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.2 f7c8533
* **deps:** update tools 294c034
